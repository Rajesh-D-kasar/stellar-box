 ...
 * Barrel export — import all components from a single path.
 *
 * Usage:
 *   import { Header, Navbar, WalletConnect, BalanceDashboard, TransferForm, TransactionStatus } from '../components';
 */
